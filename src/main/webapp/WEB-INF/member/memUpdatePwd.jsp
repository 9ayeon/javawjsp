  ...
  <table class="table table-bordered">
  	...
  	<tr>
  		<td colspan="2" class="text-center">
  			<input type="button" value="비밀번호변경" onclick="fCheck()" class="btn btn-outline-info" /> &nbsp;
  			<input type="reset" value="다시입력" class="btn btn-outline-info" /> &nbsp;
  			<input type="button" value="돌아가기" onclick="location.href='${ctp}/memMain.mem';" class="btn btn-outline-info" />
  		</td>
  	</tr>
  </table>
  </form>

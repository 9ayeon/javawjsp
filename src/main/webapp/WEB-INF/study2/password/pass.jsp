  ...
  <script>
  	...
  	function fCheck(idx){
  		...
  		if(pwd.trim() == ""){
  			...
  			/* document.getElementById("demo").innerHTML = "<font color='red'><b>콘솔 창을 확인하세여</b></font>";
...
<div class="container">
  ...
  <form name="myform" method="post">
  	<table class="table table-bordered">
  		<tr>
  			<td>
  				<p>아이디 : <input type="text" name="mid" value="9ayeon" class="form-control" /></p>
  	...
  	<input type="hidden" name="idx" /> <!--  밸류는 위에서 준다~ -->
  </form>
 <!--  <div id="demo"></div>
  <div id="demo2"></div> -->

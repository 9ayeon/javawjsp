...
<div class="container">
  ...
  <form name="myform" method="post" action="t4_ApplicationSave.jsp">
	  ...
	  <div class="row mb-3"> <!-- 지금은 jsp에서 하지만 나중엔 서블릿으로 해야함 -->
	  	<div class="col"><input type="submit" value="Application저장(서버기동후 처음 1회만 수행할 것)" class="btn btn-danger form-control"/></div>
	  	<div class="col"><a href="t4_ApplicationCheck.jsp" class="btn btn-primary form-control">Application 확인</a></div>
	  </div>
	  <div class="row">	

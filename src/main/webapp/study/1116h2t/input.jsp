...
<head>
  ...
  <link rel="stylesheet" href="${pageContext.request.contextPath}/study/1116h2t/product.css">
</head>
<body>
<div class="container">
<!-- 헤더영역('메뉴/로고' 를 표시한다. -->
...
<p><br/></p>
  ...
  <hr/>
  <div>
    <form name="myform" method="post" action="${pageContext.request.contextPath}/j1116ht/Main">
      <div>

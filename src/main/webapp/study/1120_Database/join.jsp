...
<head>
  ...
  function fCheck() {
	  // 폼의 내용을 가져와서 유효성 검사 (아이디/비밀번호/성명은 모두 20자 이하) (숙제여요..그거...머여...유효성검사...가져와서하셔,..요)
  ...
  <form name="myform" method="post" action="${pageContext.request.contextPath}/database/JoinOk" >
  	<table class="table">
  		...
  		<tr>
				...
				<input type="reset" value="다시입력" class="btn btn-outline-warning mr-3" />
				<input type="button" value="돌아가기" onclick="location.href='${pageContext.request.contextPath}/study/1120_Database/login.jsp';" class="btn btn-outline-secondary mr-3" />
				</td>  		
  		</tr>
  	</table>
  </form>
